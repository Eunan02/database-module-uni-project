...
(1, 'New Programme Promotion', 1, 1, 'On Going', '2021-01-02', NULL, 1),
(2, 'Coding Competition', 2, 2, 'Finished', '2019-01-01', '2019-01-30', 1),
(3, 'Drone Design Workshop', 1, 3, 'Finished', '2018-04-14', '2018-12-14', 1),
(4, 'Welcome Party', 3, 4, 'Planning', '2023-01-18', '2023-01-30', 1),
(5, 'Summer Undergraduate BBQ', 1, 5, 'Finished', '2016-07-06', '2016-08-06', 1);
...
(5, 6, 5, 'David Brown', 'Yes'),
(6, 6, 6, 'Carla Sampson', 'Yes'),
...
(1, 'Dr', 'Daniel', 'Dare', 10, 1, '2005-05-13', '2009-12-01', 0, 40000, 'Full time', 1),
(2, 'Lady', 'Sarah', 'Important', 12, 1, '2005-06-15', NULL, 1, 38990, 'Part time', 1),
...
(7, 'HRH', 'Prince', 'Caspian', 12, 1, '2017-01-09', NULL, 1, 21000, 'Full time', 5),
(8, 'Mr', 'Brian', 'Knuckles', 10, 3, '2008-01-07', '2010-09-30', 0, 30000, 'Full time', 6),
(9, 'Mr', 'Bob', 'Punch', 13, 1, '2008-01-07', NULL, 1, 29000, 'Full time', 6),
(10, 'Mrs', 'Natalie', 'Nononsense', 10, 1, '2010-10-13', NULL, 1, 37890, 'Full time', 6),
(11, 'Mr', 'Euan', 'Young', 11, 1, '2017-01-11', NULL, 1, 59000, 'Part time', 7),
...
(2, 'Jenny Parry', '1996-06-15', '29 Orchard Ave', 'Full time', '2017-06-30'),
